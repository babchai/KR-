        ...
        return {
            ...
            link: function ($scope, $element, $attributes) {
                ...
                if ($attributes.imageLazyLoader) {
                    //var loader = $compile('<div class="image-loader-container"><ion-spinner class="image-loader" icon="' + $attributes.imageLazyLoader + '"></ion-spinner><img src="img/loading.gif"</div>')($scope);
                    var loader = $compile('<div class="image-loader-container"><img src="img/loading.gif"</div>')($scope);
